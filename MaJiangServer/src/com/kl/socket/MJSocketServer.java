...
public class MJSocketServer extends MJServer
{
	private static Logger mLogger = LoggerFactory.getLogger(MJSocketServer.class);
	@Override
	public void Run()
	{
		// 主线程池
	...
	public MJSocketServer(String ip, int port)
	{
		super(ip, port);
	}
