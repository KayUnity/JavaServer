...
public class MJByteBufHelper 
{
	...
	public static boolean ReadHead(ByteBuf src, MJMessageHead head)
	{
		if (CanRead(src, MJMessageHead.Size()))
		{
	...
	public static ByteBuf GetByteBuf(MJMessage msg)
	{
	...
	public static ByteBuf WriteHead(MJMessageHead head)
	{
